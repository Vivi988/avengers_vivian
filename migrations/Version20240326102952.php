 ...
 */
final class Version20240326102952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE adresse (id INT AUTO_INCREMENT NOT NULL, employe_id INT NOT NULL, adresse LONGTEXT DEFAULT NULL, commune LONGTEXT NOT NULL, text VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_C35F08161B65292 (employe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE marquepages (id INT AUTO_INCREMENT NOT NULL, url LONGTEXT DEFAULT NULL, datecreation DATETIME DEFAULT NULL, commentaire LONGTEXT DEFAULT NULL, motscles LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE marquepages');
